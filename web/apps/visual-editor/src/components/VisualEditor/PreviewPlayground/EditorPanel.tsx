...
import { BottomPanel } from "../VisualPreviewPanel/BottomPanel";
import { configAtom, previewConfigAtom } from "../../../atoms/configAtoms";
...
export const EditorPanel = ({ editorWidth }: { editorWidth: number }) => {
  ...
  return (
    <div ref={containerRef} className="flex flex-col min-w-0 h-full" style={{ width: `${editorWidth}%` }}>
      <div className="flex-1 min-h-0 flex flex-col gap-tight relative">
        <CodeEditor
          ref={editorRef}
          value={config}
