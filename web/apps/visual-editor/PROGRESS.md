...
1. 预览面板需要正确集成 playground 的 PreviewPanel（可能需要检查导入路径）
2. 需要安装 `@dnd-kit/core` 和 `@dnd-kit/sortable` 依赖
3. 组件元数据定义可以继续扩展（目前有 9 个组件）
4. XML 导入时，某些复杂属性可能无法完全还原
